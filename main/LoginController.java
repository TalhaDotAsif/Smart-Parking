...
public class LoginController {
	...
	private void authenticateUser() throws IOException {
		if (emailAddressField.getText().equals("")) {
			...
			if (databaseConnector.authenticateUser(emailAddress, password)) {
				...
				System.out.println("Entered to next of authenticate");
				...
				if (userType.equals("Administrator")) {
					...
					FXMLLoader fLoader = new FXMLLoader(
					//getClass().getResource("E:/Uni Shuni/Semester 6/SE/Project/Parking System/SmartParkingSystem - Final Source/SmartParkingSystem/src/smartparkingsystem/presentation/StudentView.fxml"));
					//getClass().getResource("./smartparkingsystem/presentation/StudentView.fxml"));
	...
	void signupPromptClicked(MouseEvent event) throws IOException {
		//FXMLLoader fLoader = new FXMLLoader(getClass().getResource("E:/Uni Shuni/Semester 6/SE/Project/Parking System/SmartParkingSystem - Final Source/SmartParkingSystem/src/smartparkingsystem/presentation/Signup.fxml"));
